...
namespace Valve.VR.InteractionSystem
{
    ...
    public class BakingSodaThrow : MonoBehaviour
    {
        ...
        public GameObject bakingSodaPrefab;
        ...
        {
            clone = (GameObject)Instantiate(bakingSodaPrefab);
            clone.transform.position = new Vector3(-1.12f, 1.2f, 1.88f);
